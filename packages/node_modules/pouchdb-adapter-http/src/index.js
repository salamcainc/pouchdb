...
function HttpPouch(opts, callback) {
  ...
  api._changes = function (opts) {
    ...
    var requestTimeout = opts.timeout + CHANGES_TIMEOUT_BUFFER;

    // if heartbeat is specified, use that to determine
    // the client-side timeout (with a buffer)
    if (opts.heartbeat && requestTimeout < opts.heartbeat) {
      requestTimeout = opts.heartbeat + CHANGES_TIMEOUT_BUFFER;
    }

    var params = { timeout: opts.timeout };
